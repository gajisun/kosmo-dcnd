      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="<c:url value='/bbs/genre/kpop/Balad.jsp'/>">장르</a></li>
            <li class="dropdown">
	...
	<div class="container theme-showcase" role="main">
		...
		<div class="page-header">
			<ul class="nav nav-pills">
  				...
  				<li role="presentation" class="active"><a href="<c:url value='/bbs/genre/kpop/Dance.jsp'/>">댄스</a></li>
			...
			<table class="table table-striped">
				...
				<tbody>
					<tr>
						...
						<td>WE LIKE</td>
						<td>PRISTIN(프리스틴)</td>
						<td>The 2ed Mini Album `SCHXXL OUT`</td>
						<td>좋아요 3962</td>
					...
					<tr>
						<td>3</td>
						<td>PULLING ME DOWN (Feat. TAMY) </td>
						<td>Insidecore</td>
						<td>PULLING ME DOWN</td>
						<td>좋아요 3</td>
						<td><input type="checkbox" class="listen" checked="checked"/>듣기</td>
						<td><input type="checkbox" class="putlist" checked="checked"/>담기</td>
						<td><input type="checkbox" class="download" />다운</td>
