      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="<c:url value='/bbs/Main.jsp'/>">홈</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                ...
                <li><a href="<c:url value='/bbs/chartofsong/genre/Balad.jsp'/>">장르별 차트</a></li>
                <li><a href="#">시대별 차트</a></li>
                <!-- <li class="divider"></li>  -->
              </ul>
            </li>
            <li><a href="#contact">최신</a></li>
            <li><a href="#contact">장르</a></li>
            <li class="dropdown">
            ...
            <li><a href="<c:url value='/MusicAward.jsp'/>">뮤직어워드</a></li>
            <li class="dropdown">
