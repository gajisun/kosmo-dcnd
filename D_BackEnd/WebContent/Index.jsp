  ...
  <body role="document">
        ...
        <div class="navbar-header">
         ...
         <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="<c:url value = '/bbs/melontv/MusicVideo.jsp'/>" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">멜론TV<span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
                <li><a href="#">영상등록</a></li>
	...
	<div class="container theme-showcase" role="main">
		...
		<form class="form-signin">
			<h2 class="form-signin-heading">로그인 페이지 입니다.</h2>
